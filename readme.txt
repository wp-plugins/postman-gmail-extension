...
The Postman Gmail API Extension includes the **Google APIs Client Library for PHP**. Postman Extensions are maintained separately to keep Postman SMTP stable and lightweight. The Google API does not support password-based authentcation and you must create a (free) [OAuth 2.0 Google Client ID](https://developers.google.com/accounts/docs/OAuth2) to use this service.

= Features =
* Send Gmail (with HTTPS-XOAUTH2) from your WordPress site even if the regular mail ports are blocked
